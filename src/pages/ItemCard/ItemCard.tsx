...
export function ItemCard() {
  ...
  const iconColor = theme ? '#AFB2B6' : '#FFFFFF';
        ...
        <div className="item-card__body">
          ...
          <div className="item-card__data-wrapper">
            ...
            <div
              className={
                theme
                  ? 'item-card__actions actions dark-field actions-border-dark'
                  : 'item-card__actions actions light-field actions-border-light'
              }
            >
              <div className="actions__item" onClick={handleToggleFavoriteCard}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill={isChecked ? '#7B61FF' : `${iconColor}`}
                  />
                </svg>
              </div>
          ...
          <div className="item-card__contant-box">
            <div className="item-card__info">
              ...
              <div className="item-card__ratings-runtime ratings-runtime">
                ...
                <div className={theme ? 'ratings-runtime__icon dark-field ' : 'ratings-runtime__icon light-field'}>
                  <div className="ratings-runtime__image">
                    <img src={imdb} alt="imdb" />
                  </div>
                  <div className="ratings-runtime__number">{post.imdbRating}</div>
